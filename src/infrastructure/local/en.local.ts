...
export const en = {
  ...
  landing: {
    ...
    howItWorks: {
      ...
      step1: {
        ...
        description: 'Define the requirements and skills needed for the position.'
      },
      step2: {
        title: 'Upload CVs',
        description: 'Upload multiple CVs in PDF format for automatic analysis.'
      },
      step3: {
        title: 'Get results',
        description: 'Receive a candidate ranking with detailed analysis and recommendations.'
      }
    },
    cta: {
  ...
  help: {
    ...
    quickLinks: {
      ...
      gettingStartedDesc: 'Learn the basics to get started',
      ...
      billing: 'Billing',
      support: 'Support',
      accountDesc: 'Manage your account settings and preferences',
      billingDesc: 'View and manage your subscription and billing information',
      technical: 'Technical Support',
      technicalDesc: 'Get help with technical issues and troubleshooting'
    },
    categories: {
      gettingStarted: 'Getting Started',
      account: 'Account Management',
    ...
    faq: {
      ...
      gettingStarted: {
        ...
        q2: {
          ...
          answer: 'We accept files in PDF, DOC and DOCX format. The maximum allowed size is 10MB.'
        },
        q3: {
    ...
    contact: {
      ...
      subtitle: 'Didn\'t find what you were looking for? Our team is here to help',
      email: {
        title: 'Email',
  ...
  account: {
    ...
    profile: {
      ...
      avatarHint: 'Click to change your profile picture',
      fullName: 'Full name',
      email: 'Email address',
      phone: 'Phone',
      position: 'Position',
    ...
    notifications: {
      ...
      processCompleteDesc: 'Get notified when CV analysis is completed',
      weeklyReport: 'Weekly Report',
      weeklyReportDesc: 'Receive a weekly summary of activity and statistics',
      accountUpdates: 'Account Updates',
      accountUpdatesDesc: 'Get notified about changes to your account',
      browser: 'Browser',
      browserNotifications: 'Browser Notifications',
      browserNotificationsDesc: 'Show real-time notifications in your browser',
      save: 'Save Settings'
    },
    messages: {
      avatarChangeComingSoon: 'Avatar change coming soon'
    }
  },
  common: {
    confirm: 'Confirm',
