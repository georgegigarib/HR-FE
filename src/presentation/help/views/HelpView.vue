      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          ...
          <div class="hidden md:flex items-center space-x-8">
            <router-link to="/services" class="text-gray-600 hover:text-gray-900 transition-colors">
              {{ $t('navigation.services') }}
            </router-link>
            <router-link to="/pricing" class="text-gray-600 hover:text-gray-900 transition-colors">
              {{ $t('navigation.pricing') }}
            </router-link>
            <router-link to="/help" class="text-blue-600 font-medium">
              {{ $t('navigation.help') }}
            </router-link>
          </div>
    ...
    <section class="py-12 bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          >
            <div
              class="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4"
            >
...
const filteredFAQs = computed(() => {
  ...
  Object.keys(faqs).forEach((category) => {
    ...
    filtered[categoryKey] = faqs[categoryKey].filter(
      (faq) =>
